...
| Stripe colour | Specialization        | Code |
|---------------|-----------------------|------|
| Purple, H 118–145    | Intelligence   | P    |
| Blue,   H 92–118     | Temporal       | B    |
| Green / lime, H 36–72 | Miracle Worker | G / L |
| Orange, H 8–18       | Pilot or Command (TBD) | O |
| (none)        | no specialization      | —    |

Pilot and Command both share the orange hue; they are disambiguated by
context (ship class profile), not colour alone.
